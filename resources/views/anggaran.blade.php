                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            ...
                            @foreach ($anggaran as $a)
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $a->kode_rekening }}</td>
                                    <td>{{ $a->realisasi_gu }}</td>
                                    <td>{{ $a->realisasi_ls }}</td>
                            ...
                            <tr>
                                ...
                                <td><a href="" class="btn btn-warning rounded-circle" data-bs-toggle="modal"
                                        data-bs-target="#inlineForm1"><i class="fa fa-edit"></i></a><a href=""
                ...
                <form action="/tambahanggaran" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" placeholder="GU" class="form-control" name="nominal">
                        </div>
                        ...
                        <div class="form-group">
                            <select name="kodrek5" id="" class="form-control">
